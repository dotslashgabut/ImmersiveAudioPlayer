        ...
        reader.onload = (e) => {
            try {
                ...
                if (json && typeof json === 'object') {
                    ...
                    if (importedPreset) {
                        setPreset(importedPreset as any);
                    } else {
                        setPreset('custom');
                    }
                ...
                <section className="space-y-3">
                    ...
                    <div className="pt-2 border-t border-white/5 space-y-2">
                        <p className="text-[10px] text-zinc-500 italic leading-relaxed">
                            <span className="text-purple-400 font-bold">*Tip:</span> You can backup your configuration using the <span className="text-zinc-300">Export</span> icon.
                        </p>
                        <button
